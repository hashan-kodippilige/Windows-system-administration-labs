...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Shell-PowerShell-2CA5E0?style=for-the-badge&logo=powershell&logoColor=white" />
...
The labs cover the full lifecycle of Windows 10 administration — from initial OS deployment inside a virtualized environment through user management, security hardening, storage configuration, networking, and performance monitoring. Each chapter builds progressively on the previous, mirroring real enterprise IT workflows.

All lab documents are provided as step-by-step PDFs with screenshots and analysis of results.
...
- Registry administration and hive structure
...
| Lab | Topic |
|-----|-------|
| Chapter 1 | VMware & Windows Installation |
| Chapter 2 | Windows ADK & Activation |
| Chapter 3 | Windows Configuration |
| Chapter 4 | Storage Management |
| Chapter 5 | User Account Administration |
| Chapter 6 | Windows Security |
| Chapter 7 | Networking |
| Chapter 8 | File Management |
| Chapter 9 | Registry & .NET |
...
├── 📋 MOS Chapter 3 Lab HSK.pdf   ← Windows Configuration
├── 📋 MOS Chapter 4 Lab HSK.pdf   ← Storage Management
├── 📋 MOS Chapter 5 Lab HSK.pdf   ← User Account Administration
├── 📋 MOS Chapter 6 Lab HSK.pdf   ← Windows Security
├── 📋 MOS Chapter 7 Lab HSK.pdf   ← Networking
├── 📋 MOS Chapter 8 Lab HSK.pdf   ← File Management
├── 📋 MOS Chapter 9 Lab HSK.pdf   ← Registry & .NET
└── 📋 MOS Chapter 10 Lab HSK.pdf  ← Performance Monitoring
```
...
- **AppLocker and security policies** enforce endpoint security baselines
- **Storage management** skills are essential for data integrity and disaster recovery
- **Performance monitoring** enables proactive issue detection before systems fail
